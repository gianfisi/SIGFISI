...
INSERT INTO aulas (id_aula, lugar, cantidad) values (3, "Laboratorio 3", 10);

SELECT * FROM Solicitudes;

SELECT * FROM Eventos;

UPDATE Eventos SET imagen = "https://es.wikipedia.org/wiki/Angular_(framework)#/media/Archivo:Angular_full_color_logo.svg" WHERE titulo = "Taller Node.js";
DELETE FROM Eventos Where titulo = "Taller Angular";